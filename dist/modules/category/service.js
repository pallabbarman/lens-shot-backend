...
var insertCategory = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.category.create({
                    data: data,
                })];
            case 1:
                result = _a.sent();
...
var findAllCategories = function (filters, options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (search) {
                    andConditions.push({
                        OR: constant_1.categorySearchableFields.map(function (field) {
                            var _a;
                            return (_a = {},
                                _a[field] = {
                                    contains: search,
            ...
            case 1:
                result = _c.sent();
                return [4 /*yield*/, prisma_1.default.category.count({
                        where: whereConditions,
                    })];
            case 2:
                total = _c.sent();
...
var findCategory = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var editCategory = function (id, payload) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.category.update({
                    where: {
                        id: id,
                    },
                    include: {
...
var removeCategory = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.category.delete({
                    where: {
                        id: id,
                    },
                })];
